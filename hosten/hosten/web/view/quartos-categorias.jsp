    ...
    <body>
        ...
        <main>            
            ...
            <div class="card-action right-align button-box">
                <a href="/hosten/servletweb?acao=ListarItensConforto&tipoAcao=SelectCategoriaQuarto"><button id="add-button" class="btn waves-effect waves-light"><i class="material-icons left">add_circle_outline</i>Nova Categoria de Quarto</button></a>
            </div>
        </main>
