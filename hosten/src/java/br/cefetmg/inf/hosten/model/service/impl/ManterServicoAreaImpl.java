...
public class ManterServicoAreaImpl implements ManterServicoArea {
    ...
    public boolean excluir(String codRegistro)
        ...
        List<Servico> listaServicos = servicoDAO.busca(codRegistro, "codServicoArea");
        if (!listaServicos.isEmpty()) {
            throw new NegocioException("Não é possível excluir essa área de serviço. Há " + listaServicos.size() + " serviços nela.");
        }
